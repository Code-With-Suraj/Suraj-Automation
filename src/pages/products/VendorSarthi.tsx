...
export default function VendorSarthi() {
  ...
  const isPurchased = hasPurchased('vendorsarthi');
    ...
    <main className="pt-24 pb-20">
          ...
          <div className="max-w-4xl">
            ...
            >
              ...
              <div className="flex flex-wrap gap-4 mt-8">
                ...
                <a 
                  href="https://wa.me/918851666208?text=Hi%20Suraj,%20I%20want%252520a%252520free%252520demo%252520of%252520VendorSarthi." 
                  target="_blank" 
      ...
      <section className="bg-slate-50 dark:bg-slate-900/10 py-12 border-t border-b border-slate-200/50 dark:border-slate-800/50">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <RazorpayCheckout productId="vendorsarthi" />
        </div>
      </section>
